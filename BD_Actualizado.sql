...
INSERT INTO `tapes_renewal` (`ID_TAP_Renewal`, `Renewal_Date`, `Sent_Request_CTC`, `Sent_Customer`, `Returned_Cust_Signed`, `FK_ID_TAP_PPAP`) VALUES
...
CREATE TABLE IF NOT EXISTS `tubes_ppap` (
  ...
  KEY `FK1_TUB_Customers-TUB_PPAP` (`FK_ID_TUB_Customer`) USING BTREE,
  CONSTRAINT `FK1_TUB_Customers-TUB_PPAP` FOREIGN KEY (`FK_ID_TUB_Customer`) REFERENCES `tubes_customers` (`ID_TUB_Customer`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

-- Dumping data for table eurotechdb.tubes_ppap: ~36 rows (approximately)
INSERT INTO `tubes_ppap` (`PPAP_Number`, `Vendor`, `FK_ID_TUB_Customer`, `Country`) VALUES
	('PP00012-01', 'UPM', 9, 'Mexico'),
	('PP00012-02', 'UPM', 9, 'Mexico'),
	('PP00012-03', 'UPM', 9, 'Mexico'),
	('PP00012-04', 'UPM', 9, 'Mexico'),
	('PP00012-05', 'ETC', 9, 'Mexico'),
	('PP00014-01', 'ETC', 10, 'Mexico'),
	('PP00015-1', 'UPM', 11, 'Germany'),
	('PP00016-1', 'UPM', 12, 'North America'),
	('PP00016-2', 'UPM', 12, 'North America'),
	('PP00016-3', 'UPM', 12, 'North America'),
	('PP00017-1', 'UPM', 12, 'Morocco'),
	('PP00017-2', 'UPM', 12, 'Morocco'),
	('PP00019-02', 'ETC', 13, 'Mexico'),
	('PP00019-03', 'KTG', 13, 'Mexico'),
	('PP00019-04', 'KTG', 13, 'Mexico'),
	('PP00024-01', 'UPM', 6, 'EU'),
	('PP00024-02', 'UPM', 6, 'EU'),
	('PP00024-03', 'ETC', 6, 'EU'),
	('PP00024-04', 'ETC', 6, 'EU'),
	...
	('PP00024-10', 'ETC', 6, 'EU'),
	('PP00024-27', 'ETC', 6, 'EU'),
	('PP00025-01', 'UPM', 5, 'Mexico'),
	('PP00026-01', 'ETC', 4, 'Mexico'),
	('PP00045-03', 'ETC', 3, 'Mexico'),
	('PP00061-11', 'ETC', 7, 'North America'),
	('PP00061-12', 'ETC', 7, 'North America'),
	('PP00062-01', 'ETC', 7, 'Brazil'),
	('PP00062-02', 'ETC', 7, 'Brazil'),
	('PP00067-12', 'UPM', 8, 'Japan'),
	('PP00067-13', 'ETC', 8, 'Japan'),
	('PP00067-14', 'ETC', 8, 'Japan'),
	('PP00067-15', 'ETC', 8, 'Japan'),
	('PP00067-16', 'ETC', 8, 'Japan');
