    ...
    <div class="table-responsive">
        <table class="table table-bordered">
            <tr>
                ...
                <th style="background-color:#1c18AA; color:white" colspan="4">2024</th>
                <th style="background-color:#1c18AA; color:white" colspan="4">2025</th>
            ...
            <?php foreach ($logs as $log) { ?>
                <tr>
                    ...
                    if($log['Cust_Signed-Sent_CTC'] == NULL) { ?>
                        <td></td>
                    <?php } 
                    $Renewlogs24 = $model->searchRenew24($log['ID_TAP_PPAP'] );
                    if($Renewlogs24 == NULL) { ?>
                        <td></td>
                        <td></td>
                        <td></td>
                        <td></td>
                    <?php }
                    foreach ($Renewlogs24 as $Renewlog) { 
                    ...
                    $Renewlogs25 = $model->searchRenew25($log['ID_TAP_PPAP'] );
                    if($Renewlogs25 == NULL) { ?>
                        <td></td>
                        <td></td>
                        <td></td>
                        <td></td>
                    <?php }
                    foreach ($Renewlogs25 as $Renewlog) { 
                        if($Renewlog['Renewal_Date'] != NULL) { 
                            $renDate = new DateTime($Renewlog['Renewal_Date']); ?>
                            <td><?php echo $renDate->format('m/d/Y') ?></td>
                        <?php }
